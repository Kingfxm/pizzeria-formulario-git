...
const Cart = () => {
  ...
  const {cart,addCant,sustCant,deleteCart,envio,setEnvio,totalitems,total,checkout} = useContext(CartContext)
                  ...
                  <div className="row g-0">
                    ...
                    <div className="col-lg-4 bg-body-tertiary">
                      <div className="p-5">
                        ...
                        <button type="button" onClick={() => checkout()} className={logged && total !== 0 ? "btn btn-secondary btn-block btn-lg" : "btn btn-secondary btn-block btn-lg disabled" }>Ir a pagar</button>
                        <p className='pt-2' style={{display:logged || total === 0 ? "none" : ""}}>Debes iniciar sesión</p>
